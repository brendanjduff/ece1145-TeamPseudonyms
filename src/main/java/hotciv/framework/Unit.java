...
/**
 * Represents a single unit in the game. Responsibilities: 1) Know its type name. 2) Know its owner.
...
public interface Unit {
   ...
   * distance of N in this turn. The move count is reset to the units maximal value before a new
   * turn starts.
   *
