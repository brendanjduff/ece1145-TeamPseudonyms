...
public interface Game {
   ...
   * Position p is a valid position in the world.
   *
  ...
  /**
   * move a unit from one position to another. If that other position is occupied by an opponent
   * unit, a battle is conducted leading to either victory or defeat. If victorious then the
   * opponent unit is removed from the game and the move conducted. If defeated then the attacking
   * unit is removed from the game. If a successful move results in the unit entering the position
   * of a city then this city becomes owned by the owner of the moving unit. Precondition: both from
   * and to are within the limits of the world.  Precondition: there is a unit located at position
   * from.
   *
   * @param from the position that the unit has now
   * @param to   the position the unit should move to
   * @return true if the move is valid (no mountain, move is valid under the rules of the game
   ...
   * turn. If all players have had their turns then do end-of-round processing: A) restore all
   * units' move counts B) produce food and production in all cities C) produce units in all cities
   ...
   * in the city. Precondition: there is a city at location 'p'.
   *
   * @param p       the position of the city whose focus should be changed.
   ...
   * 'p'. Predondition: the unit type is a valid type.
   *
   ...
   * new city at its location. Precondition: there is a unit at location 'p'.
   *
